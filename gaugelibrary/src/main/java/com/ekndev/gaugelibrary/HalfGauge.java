...
public class HalfGauge extends AbstractGauge {
    ...
    private void drawMinValue(Canvas canvas) {
       ...
       // canvas.rotate(26, 10f, 130f);
        canvas.drawText(getFormattedValue(getMinValue()) + "", 0f + getPadding(), 240f, getRangeValue(getMinValueTextColor()));
        canvas.restore();
    }
    ...
    private void drawMaxValue(Canvas canvas) {
       ...
       // canvas.rotate(-26, 390f, 130f);
        canvas.drawText(getFormattedValue(getMaxValue()) + "", 390f - getPadding(), 240f, getRangeValue(getMaxValueTextColor()));
        canvas.restore();
    }
